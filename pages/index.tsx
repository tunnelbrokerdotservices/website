      ...
      <main>
        <div className="container mx-auto px-4 dark:text-white">
          ...
          <div className="my-4 flex flex-row items-center gap-4 rounded-md border-2 border-black dark:border-gray-700 p-5">
            ...
            <span>{"Due to the removal of Wikipedia's IPv6 Tunnel Broker List on the 13th of August 2022, We have created this page for users to share for those that wish to find IPv6 Tunnel Broker Services. If you wish to be added to this list please open an issue at https://github.com/tunnelbrokerdotservices/website"}</span>
          </div>
